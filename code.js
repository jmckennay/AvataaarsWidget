...
function Widget() {
    ...
    return (figma.widget.h(AutoLayout, { verticalAlignItems: 'center', spacing: 8, padding: 16, cornerRadius: 8, fill: '#FFFFFF', stroke: '#E6E6E6' },
        ...
        figma.widget.h(Text, { fontSize: 32, width: 42, horizontalAlignText: 'center' }, count),
        figma.widget.h(SVG, { src: `<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="30" height="30" rx="15" fill="white"/>
