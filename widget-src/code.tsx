...
function Widget() {
  ...
  const randomise = () => {
    ...
    figma.ui.postMessage({ type: 'randomise', options: { style: selectedOptions.style } })
  }
  ...
  usePropertyMenu(propertyMenu, ({ propertyName }) => {
    return new Promise( (resolve) => {
      if (propertyName === 'randomise') randomise()
      if (propertyName === 'customise') customise()
